...
router.post(
  "/Crear_pregunta_clave_valor",
  upload.single("file"),
  SP_crear_pregunta_clave_valor_OPCLAVA
);
router.get("/Obtener_Claves/:id", Claves_Preguntas);
router.post(
  "/Crear_pregunta_clave_valor_noJSON",
  upload.single("file"),
  SP_crear_pregunta_clave_valor_OPCLAVA_no_json
);
//SP_crear_pregunta_clave_valor_OPCLAV2_no_json
router.post(
  "/Crear_pregunta_clave_valor_noJSON2",
  upload.single("file"),
  SP_crear_pregunta_clave_valor_OPCLAV2_no_json
);

router.post(
  "/Crear_respuesta1ClaveValor",
  uploadRes.single("file"),
  crear_respuesta_CLAVE_VALOR
);
//crear_respuesta_CLAVE_VALOR_2
router.post(
  "/Crear_respuesta1ClaveValor2",
  uploadRes.single("file"),
  crear_respuesta_CLAVE_VALOR_2
);
...
//Para listar los valores de las claves de las preguntas OPCLAVA y OPCLAV2
router.get(
  "/valores_claves_preguntas_editar/:id",
  valores_claves_preguntas_editar
);
//editar_respuestas_clave_valor
